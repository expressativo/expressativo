Rails.application.routes.draw do
  ...
  # Render dynamic PWA manifest from app/views/pwa/* (remember to link manifest in application.html.erb)
  get "manifest" => "rails/pwa#manifest", as: :pwa_manifest
  # The service worker is served as a static file from public/service_worker.js
